...
const pricingPlans = [
    {
      ...
      features: [
        "AI personality and skills assessments",
        "Basic career path recommendations",
        "Career explorer with 100+ professions",
        "10 AI advisor questions per month",
    ...
    },
    {
      ...
      features: [
        "Unlimited AI career advisor chat",
    ...
    },
    {
      ...
      features: [
        ...
        "Priority AI response & analysis",
        "Custom career strategy with quarterly reviews",
        "Salary negotiation support",
        "Networking connections in your industry",
    ...
    <section className="w-full px-5 overflow-hidden flex flex-col justify-start items-center my-0 py-8 md:py-14">
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing built for every professional
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your needs, from individuals starting their career to <br /> professionals advancing and organizations building teams.
          </p>
        </div>
        <div className="pt-4">
      ...
      <div className="self-stretch px-5 flex flex-col md:flex-row justify-start items-start gap-4 md:gap-6 mt-6 max-w-[1100px] mx-auto">
        {pricingPlans.map((plan) => (
          <div
            key={plan.name}
            className={`flex-1 p-4 overflow-hidden hover:shadow-white transition-shadow transition-smooth shadow-md rounded-xl flex flex-col justify-start items-start gap-6 ${plan.popular ? "bg-primary shadow-[0px_4px_8px_-2px_rgba(0,0,0,0.10)]" : "bg-gradient-to-b from-gray-50/5 to-gray-50/0"}`}
