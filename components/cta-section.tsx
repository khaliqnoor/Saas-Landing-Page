    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-3xl md:text-4xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[600px] lg:max-w-[700px]">
  Find career clarity in minutes, not months
</h2>
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
             Stop guessing and start growing. Get AI-powered career guidance that shows you exactly where to go and how to get there
          </p>
        </div>
        <Link href="https://vercel.com/home" target="_blank" rel="noopener noreferrer">
          <Button
            className="px-[30px] py-2 bg-secondary hover:shadow-white transition-shadow transition-smooth shadow-md text-secondary-foreground text-base font-medium leading-6 rounded-[99px]  hover:bg-secondary/90 transition-all duration-200"
            size="lg"
          >
            Signup for free
          </Button>
